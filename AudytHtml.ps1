...
$fileJson = ("{0}.json" -f $zmPC.pcName)
$zmPC | ConvertTo-Json | Out-File ("\\ad1\wrzutowy\00audyt\{0}" -f $fileJson)
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td colspan="2"><input type="text" name="Druk" id="Druk" value="$nrEwid" placeholder="Wpisz nr ewidencyjny"></td>
            </tr>
        </tbody>
    </table>
    <p>Oprogramowanie</p>
...
<tbody>
    <tr>
        <td><input type="text" name="Lokalizacja" id="Lokalizacja" value="$lokalizacja" placeholder="Lokalizacja, dział oddział komputera"></td>
    </tr>
    <tr>
        <td>&nbsp;</td>
    </tr>
...
<tbody>
    <tr>
        ...
        <td><input type="text" name="osoba" id="osoba" value="$odpowiedzialny" placeholder="Osoba odpowiedzialna"></td>
        <td></td>
    </tr>
    <tr>
        <td>2.</td>
...
ConvertTo-Html -Title "Strona Html" -Body "$page$p1$page3" -Head "$css" | Out-File \\ad1\wrzutowy\00audyt\PCTemp.html
Invoke-Item \\ad1\wrzutowy\00audyt\PCTemp.html