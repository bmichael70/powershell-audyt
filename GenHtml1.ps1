#Get-CimInstance -Class Win32_OperatingSystem | Select-Object Version,Caption,Build,Manufacturer | ConvertTo-Html | Out-File -FilePath .\Basic-Information-Report.html
